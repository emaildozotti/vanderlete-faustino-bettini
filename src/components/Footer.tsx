...
const COPY = {
  ...
  heading: 'Você pode esperar mais um ano, ou pode descobrir hoje',
  headingEm: 'o que está te travando.',
  subtitle: 'A primeira sessão te mostra o que está bloqueando a sua vida. Sem pressão e sem decisão na hora.',
