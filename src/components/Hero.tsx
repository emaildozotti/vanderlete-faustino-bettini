...
// ════════════════════════════════════════════════════════════════════
const COPY = {
  callout: 'SUA VIDA PAROU?',
  h1: 'Você olha pra trás e vê que queria muito,',
  h1Em: 'mas nada saiu do lugar.',
  subtitle: 'Existe um caminho de volta pra quem se sente parado, sem identidade e cansado de tentar sem resultado.',
  ctaPrimary: 'Agendar minha primeira sessão',
  ctaSecondary: 'ou conhecer o método',
}
// ════════════════════════════════════════════════════════════════════
